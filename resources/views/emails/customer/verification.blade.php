                    ...
                    <tr>
                        <td style="padding:36px 32px 8px;">
                            ...
                            <p style="margin:0 0 24px; font-size:15px; color:#4b5563;">
                                Your booking is confirmed in our system. Create a customer account so you can view your bookings, invoices, and manage your stay any time.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:20px 24px;">
                                        ...
                                        <ol style="margin:0; padding-left:18px; font-size:14px; color:#4b5563; line-height:1.8;">
                                            ...
                                            <li>Create a password to activate your customer portal.</li>
                                        </ol>
                                    </td>
                                </tr>
                            </table>
